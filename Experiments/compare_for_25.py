...
# plrank2
params1 = {
    "eta": 0.40960449433597856,
    "min_child_weight": 3,
    "max_depth": 8,
    "gamma": 6.385498441987814,
    "alpha": 8.046672078073955,
    "eval_metric": "ndcg@25",
}
num_round = 200
...
params2 = {
    ...
    "eta": 0.2540113979178067,
    "min_child_weight": 9,
    "max_depth": 10,
    "gamma": 1.8134755128766586,
    "alpha": 9.140023331689202,
    "eval_metric": "ndcg@25",
}
evals_result2 = {}
...
params3 = {
    "objective": "rank:ndcg",
    "eta": 0.45402389322894404,
    "min_child_weight": 7,
    "max_depth": 10,
    "gamma": 0.004744995040238866,
    "alpha": 9.12046422926295,
    "eval_metric": "ndcg@25",
}
evals_result3 = {}
...
# make a plot
t = np.arange(1, 201)
plt.plot(t, evals_result1["test"]["ndcg@25"], label="PL-Rank-2 (N = 100, K = 25)")
plt.plot(t, evals_result2["test"]["ndcg@25"], label="LambdaMART (Pairwise)")
plt.plot(t, evals_result3["test"]["ndcg@25"], label="LambdaMART (Listwise)")
...
plt.savefig("figures/compare_25.png", dpi=128)