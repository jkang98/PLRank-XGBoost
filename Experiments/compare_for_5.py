...
# plrank2
params1 = {
    "eta": 0.3424916786320363,
    "min_child_weight": 7,
    "max_depth": 9,
    "gamma": 1.214551167470019,
    "alpha": 1.0807769330512789,
    "eval_metric": "ndcg@5",
}
num_round = 200
...
params2 = {
    ...
    "eta": 0.36422622162370766,
    "min_child_weight": 6,
    "max_depth": 9,
    "gamma": 4.658704366866753,
    "alpha": 8.197694535858151,
    "eval_metric": "ndcg@5",
}
evals_result2 = {}
...
params3 = {
    "objective": "rank:ndcg",
    "eta": 0.4443297723755526,
    "min_child_weight": 9,
    "max_depth": 8,
    "gamma": 0.4367066309492815,
    "alpha": 5.128040956825057,
    "eval_metric": "ndcg@5",
}
evals_result3 = {}
...
# make a plot
t = np.arange(1, 201)
plt.plot(t, evals_result1["test"]["ndcg@5"], label="PL-Rank-2 (N = 100, K = 5)")
plt.plot(t, evals_result2["test"]["ndcg@5"], label="LambdaMART (Pairwise)")
plt.plot(t, evals_result3["test"]["ndcg@5"], label="LambdaMART (Listwise)")
...
plt.savefig("figures/compare_5.png", dpi=128)