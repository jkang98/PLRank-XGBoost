...
# plrank2
params1 = {
    "eta": 0.32062072855572404,
    "min_child_weight": 2,
    "max_depth": 4,
    "gamma": 7.105229181373642,
    "alpha": 4.392330867907922,
...
params2 = {
    ...
    "eta": 0.25197012786660805,
    "min_child_weight": 7,
    "max_depth": 8,
    "gamma": 4.395177854826028,
    "alpha": 4.330926546219153,
    "eval_metric": "ndcg@100",
}
evals_result2 = {}
...
params3 = {
    "objective": "rank:ndcg",
    "eta": 0.3745075382861628,
    "min_child_weight": 4,
    "max_depth": 10,
    "gamma": 0.34621484302922917,
    "alpha": 0.48167127717647107,
    "eval_metric": "ndcg@100",
}
evals_result3 = {}
...
# make a plot
t = np.arange(1, 201)
plt.plot(t, evals_result1["test"]["ndcg@100"], label="PL-Rank-2 (N = 100, K = 100)")
plt.plot(t, evals_result2["test"]["ndcg@100"], label="LambdaMART (Pairwise)")
plt.plot(t, evals_result3["test"]["ndcg@100"], label="LambdaMART (Listwise)")
...
plt.savefig("figures/compare_100.png", dpi=128)