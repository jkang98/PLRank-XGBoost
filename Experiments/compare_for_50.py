...
# plrank2
params1 = {
    "eta": 0.15224024565414965,
    "min_child_weight": 8,
    "max_depth": 4,
    "gamma": 0.6238296836845141,
    "alpha": 5.546834953771762,
    "eval_metric": "ndcg@50",
}
num_round = 200
...
params2 = {
    ...
    "eta": 0.2721014485257162,
    "min_child_weight": 4,
    "max_depth": 8,
    "gamma": 8.526903165803713,
    "alpha": 8.152353537846627,
    "eval_metric": "ndcg@50",
}
evals_result2 = {}
...
params3 = {
    "objective": "rank:ndcg",
    "eta": 0.3890726629152702,
    "min_child_weight": 8,
    "max_depth": 10,
    "gamma": 0.036029500516172264,
    "alpha": 4.737289663177091,
    "eval_metric": "ndcg@50",
}
evals_result3 = {}
...
# make a plot
t = np.arange(1, 201)
plt.plot(t, evals_result1["test"]["ndcg@50"], label="PL-Rank-2 (N = 100, K = 50)")
plt.plot(t, evals_result2["test"]["ndcg@50"], label="LambdaMART (Pairwise)")
plt.plot(t, evals_result3["test"]["ndcg@50"], label="LambdaMART (Listwise)")
...
plt.savefig("figures/compare_50.png", dpi=128)